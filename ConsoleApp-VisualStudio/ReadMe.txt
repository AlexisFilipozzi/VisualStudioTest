========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet ConsoleApp-VisualStudio
========================================================================

AppWizard a créé cette application ConsoleApp-VisualStudio pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application ConsoleApp-VisualStudio.


ConsoleApp-VisualStudio.vcxproj
...
ConsoleApp-VisualStudio.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) ConsoleApp-VisualStudio.pch et un fichier de type précompilé nommé StdAfx.obj.
